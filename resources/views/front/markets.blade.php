...
<div class="common_hero">
	<div class="text_box">
        <div class="title wow fadeInUp" data-wow-delay="0.1s">Markets</div>   
        <div class="sub_title wow fadeInUp" data-wow-delay="0.2s">OEC’s comprehensive and diverse product portfolio offers solutions for a variety of industries.</div>   
    </div>
</div>
    ...
    <div class="text_on_image lightning_protection">
        <div class="inner_box">
            <div class="text_box wow">
                ...
                <p>Discover OEC’s Electrical Connectors and Fittings for Lightning Protection. Our products are essential components in the lightning protection market, ensuring the safety and integrity of structures and equipment. From ground rods to UL 96 listed connectors to surge protection equipment, our solutions provide reliable protection against lightning strikes and electrical surges. Trust us for superior quality and performance in lightning protection systems. Contact us today to learn more.</p>
            </div>
        </div>
    </div>
