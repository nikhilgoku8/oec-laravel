                ...
                <div class="page-header my_style less_margin">
                    <div class="left_section">
                        <div class="title_text">
                            <div class="title">Edit Filter Value</div>
                    ...
                    <div class="input_boxes">
                        <div class="col-sm-12">
                            <div class="input_box">
                                ...
                                <div class="error form_error" id="form-error-filter_type_id"></div>
...
$(document).ready(function() {
    ...
    $("#data_form").on('submit',(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('filter-values.update', $result->id) }}",
            data:  formData,
            dataType: 'json',
            cache: false,
            contentType: false,
            ...
            success: function(result) {
                location.href="{{ route('filter-values.index') }}";
            },
            error: function(data){
                if (data.status === 422) {
