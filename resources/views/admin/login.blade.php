		        ...
		        <div class="col-md-4 col-md-offset-4">
		            <div class="login-panel panel panel-default">
		            	<div class="panel-logo">
		            		<div class="image"><img src="admin/assets/images/logo.jpg"></div>
		            	</div>
		    ...
		    $.ajax({
		        ...
		        success: function(result) {            
		            ...
		            if(result.userType=='client'){
		            	location.href = BaseUrl.siteRoot+"owm/clientdashboard/?year="+<?php echo date('Y'); ?>;
		            }else{
		            	location.href = BaseUrl.siteRoot+"owm/dashboard";
		            }		            
		        },
		        error: function(data){
		            ...
		            }else if(responseData.error_type=='database'){
		            	$("#form_login_notification").addClass('form_login_error');
		            	$("#form_login_notification").html(responseData.message);
		            }
		        }
