        ...
        <div class="col-lg-12">
            <div class="page-header my_style">
                <div class="left_section">
                    <h1 class="">Representative States Import Data</h1>
                    <ul class="breadcrumb">
                        <li><a href="{{ route('dashboard') }}">Home</a></li>
                        <li><a href="{{ route('representatives_states_data.edit') }}">Representative States Import Data</a></li>
                    </ul>    
                </div>
...
$(document).ready(function() {
    ...
    $("#data_form").on('submit',(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('representatives_states_data.store') }}",
            ...
            success: function(result) {
                location.href="{{ route('representatives_states_data.edit') }}";
            },
            error: function(data){
