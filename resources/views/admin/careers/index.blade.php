            ...
            <div class="page-header my_style">
                ...
                <div class="right_section">
                    <!-- <div class="purple_hollow_btn">
                        <a href="{{ route('careers.create'); }}">Add New</a>
                    </div> -->
    ...
    <div class="row">
        <div class="fourth_row">
            ...
            <div class="my_panel">
                ...
                <div class="upper_sec">
                    <div class="left_section">
                        <div class="title">Careers Data</div>
                            ...
                            @if(!empty($result))
                                @foreach ($result as $row)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{ route('careers.show', $row->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <span class="checkbox">
