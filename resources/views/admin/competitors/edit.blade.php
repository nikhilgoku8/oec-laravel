                ...
                <div class="page-header my_style less_margin">
                    <div class="left_section">
                        <div class="title_text">
                            <div class="title">Edit Competitor</div>
                        ...
                        <div class="col-sm-12">
                            <div class="input_box">
                                ...
                                <select name="product_id">
                                    ...
                                    <option value="{{$product->id}}" @selected($product->id == $result->product_id)>{{$product->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $("#data_form").on('submit',(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('competitors.update', $result->id) }}",
            data:  formData,
            dataType: 'json',
            cache: false,
            contentType: false,
            ...
            success: function(result) {
                location.href="{{ route('competitors.index') }}";
            },
            error: function(data){
                if (data.status === 422) {
