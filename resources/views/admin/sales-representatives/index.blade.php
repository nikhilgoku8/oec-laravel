    ...
    <div class="row">
        <div class="fourth_row">
            ...
            <div class="my_panel">
                ...
                <div class="upper_sec">
                    <div class="left_section">
                        <div class="title">Sales Representatives Data</div>
                            ...
                            @if($result->isNotEmpty())
                                @foreach ($result as $row)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{ route('sales-representatives.edit', $row->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                            <span class="checkbox">
  ...
  $("#delete_records").on('click',(function(e){
    ...
    if(dataID.length == 0){
        ...
        if (confirm('Are you sure you want to delete these records?')) {
            $.ajax({
                type: "POST",
                url: "{{ route('sales-representatives.bulk-delete') }}",
